    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-between" style={{ gap: 40 }}>
        <div className="flex gap-6 items-start">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0052e6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="shrink-0 mt-1">
        ...
        <div className="flex gap-6 items-start">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0052e6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="shrink-0">
